...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-mod-001-cherlin-zilber-conjecture-350b0750",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-mod-001-c1a8bd8040c5",
        "url": "https://www.unsolvedmath.com/problems/MOD-001"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Is every simple group with a stable first-order theory an algebraic group over an algebraically closed field?",
      "version": 1
    },
    "title": "Cherlin-Zilber Conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "66a8fa36280bb1c119d25ed35f50bda6e025f5d32888a147757329ae03fffec3"
}
```
